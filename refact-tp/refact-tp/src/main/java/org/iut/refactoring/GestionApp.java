...
class GestionApp {
    public static void main(String[] args) {
        ...
        String aliceId = (String) app.employes.getFirst().getNom();
        ...
        GenerateurRapport.generationRapport("SALAIRE", "IT", app);
        GenerateurRapport.generationRapport("EQUIPE", null, app);
